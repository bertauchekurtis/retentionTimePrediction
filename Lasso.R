...
predictions <- predict(bestModelminLambda_one, newx = Xtest_one)
calcStats(dataOne_test$RetentionTime, predictions)

predictions <- predict(bestModelOneSELambda_one, newx = Xtest_one)
calcStats(dataOne_test$RetentionTime, predictions)

predictions <- predict(bestModelminLambda_two, newx = Xtest_two)
calcStats(dataTwo_test$RetentionTime, predictions)

predictions <- predict(bestModelOneSELambda_two, newx = Xtest_two)
calcStats(dataTwo_test$RetentionTime, predictions)